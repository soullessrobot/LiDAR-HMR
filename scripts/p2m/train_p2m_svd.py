...
from models.pose2mesh.pointcloud2mesh_net import pointcloud2mesh_net, p2m_svd
...
def test(model, dataloader, show = False):
    ...
    for sample in tqdm(dataloader):
        ...
        error_edges, error_relative_edges = mean_per_edge_error(pred_vertices, gt_vertices, model.p2m.mesh_model.face)
        mpve += error_vertices
...
model_type = 'p2m_svd' #'lpformer', 'v2v'
...
if args.p2m_state_dict != '':
    ...
    model.p2m.load_state_dict(state_dict['net'])
