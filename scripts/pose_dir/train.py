...
from models.pose_mesh_net import pose_mesh_net, pose_meshformer, pose_meshgraphormer, pose_dir
...
model_type = 'pose_dir' #'lpformer', 'v2v'
...
if config.NETWORK.PRN_PRETRAINED:
    if args.state_dict != '':
        ...
        # import pdb; pdb.set_trace()
        model.pct_pose.load_state_dict(state_dict['net'], strict = False)
if args.resume_state_dict != '':
    state_dict = torch.load(args.resume_state_dict)
