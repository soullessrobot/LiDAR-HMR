...
# from models.v2v.v2v_posenet import LPFormer
...
def test_and_save_waymo(model, dataloader, save_folder = 'pose_results/lpformer/waymo'):
    print('============Testing============')
    pred_poses = {}
    for sample in tqdm(dataloader):
...
def test_and_save_humanm3(model, dataloader, save_folder = 'pose_results/lpformer/humanm3'):
    print('============Testing============')
    pred_poses = {}
    for sample in tqdm(dataloader):
        pcd = sample['human_points'].cuda()
...
def test_and_save_lidarh26m(model, dataloader, save_folder = 'pose_results/lpformer/lidarh26m', is_train = True):
    print('============Testing============')
    pred_poses = {}
    for sample in tqdm(dataloader):
        pcd = sample['human_points'].cuda()
