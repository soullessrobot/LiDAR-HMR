...
model_folder = '/Extra/fanbohao/fbh_code/mesh/FaceFormer/models/graphormer/'
...
class SMPL(nn.Module):
    ...
    def __init__(self, gender='neutral'):
        ...
        self.faces = torch.from_numpy(smpl_model['f'].astype(np.int64))
...
class Mesh(object):
    ...
    def __init__(self, filename=model_folder + 'data/mesh_downsampling.npz',
